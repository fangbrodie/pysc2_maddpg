...
from maddpg.sc2_env.runner import run_loop
...
flags.DEFINE_integer("screen_resolution", 40,
                     "Resolution for screen feature layers.")
flags.DEFINE_integer("minimap_resolution", 40,
                     "Resolution for minimap feature layers.")

flags.DEFINE_integer("max_agent_steps", 20000000, "Total agent steps.")
flags.DEFINE_integer("game_steps_per_episode", 0, "Game steps per episode.")
flags.DEFINE_integer("step_mul", 1, "Game steps per agent step.")

flags.DEFINE_string("agent", "maddpg.maddpg.agent.MADDPG",
                    "Which agent to run")
flags.DEFINE_enum("agent_race", None, sc2_env.races.keys(), "Agent's race.")
flags.DEFINE_enum("bot_race", None, sc2_env.races.keys(), "Bot's race.")
flags.DEFINE_enum("difficulty", "9", sc2_env.difficulties.keys(),
                  "Bot's strength.")
